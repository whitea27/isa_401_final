...
To analyze customer sentiment, I needed a reliable source of reviews. I initially explored scraping platforms such as Google Reviews, OpenTable, and TripAdvisor, but ran into limitations related to access, structure, and scraping restrictions. Instead, I used the Yelp Open Review and Business Datasets, which are designed for academic use. These datasets provide structured information including review text, timestamps, ratings, and business location data, making it ideal for joining with external data sources.
